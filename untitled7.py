...
Original file is located at
    https://colab.research.google.com/drive/1B2ItxCr5maJdzg1s3be9fj4ID4bEfmG0
"""
...
# Example usage
wav_file_path = 'guitar.wav'  # Replace with your WAV file path
...
# Matnni belgilash
text = "hi everyone wolcame to google colab"
